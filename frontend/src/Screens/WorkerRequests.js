      ...
      {requests.map(request => (
        <div className="border border-gray-200 shadow-lg w-full px-4 py-2 mb-4 rounded-md">
          ...
          <p className={`${!show && "line-clamp-3"} my-2`}>
            ...
            buddy How are you buddy Hi, How are you buddy How are you buddy Hi,
            How are you buddy Hi, How are you buddy How are you buddy Hi, How
            are you buddy How are you buddy Hi, How are you buddy How are you
            buddy Hi, How are you buddy How are you buddy{" "}
          </p>
          {!show ? (
            <button
          ...
          <div className="grid grid-cols-3 gap-6 mb-4">
            {request.images.map(image => (
              <img className="w-full object-contain rounded-t-md" src={image} />
            ))}
          </div>
